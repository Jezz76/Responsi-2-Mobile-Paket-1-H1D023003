...
class AddInventarisScreen extends StatefulWidget {
  const AddInventarisScreen({Key? key}) : super(key: key);
...
class _AddInventarisScreenState extends State<AddInventarisScreen> {
  ...
  Future<void> _addInventaris() async {
    if (!_formKey.currentState!.validate()) return;

    setState(() => _isLoading = true);

    try {
      await _inventarisService.createInventaris(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tambah Inventaris Jeskris'),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: _isLoading ? null : _addInventaris,
